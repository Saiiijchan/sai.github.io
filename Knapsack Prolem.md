...
相比于分析一，此种方法不是在O(1)时间求得dp[i][j]，所以总的时间复杂度就比分析一大些了，为 ![[公式]](https://www.zhihu.com/equation?tex=+O%28NW+%5Cfrac+W+%7B%5Cbar%7Bw%7D%7D%29)级别。
...
更高效的转化方法是采用二进制的思想：把第 i 种物品拆成重量为 ![[公式]](https://www.zhihu.com/equation?tex=w_i+2%5Ek) 、价值为 ![[公式]](https://www.zhihu.com/equation?tex=v_i+2%5Ek) 的若干件物品，其中 k 取遍满足 ![[公式]](https://www.zhihu.com/equation?tex=w_i+2%5Ek+%5Cle+W) 的非负整数。这是因为不管最优策略选几件第 i 种物品，总可以表示成若干个刚才这些物品的和（例：13 = 1 + 4 + 8）。这样就将转换后的物品数目降成了对数级别。
...
总的时间复杂度约为 ![[公式]](https://www.zhihu.com/equation?tex=O%28NW%7B%5Cbar%7Bn%7D%7D%29+%3D+O%28W+%5Csum_i+%7Bn_i%7D%29) 级别。

### 3.3 分析二、转换成01背包

采用2.4节类似的思路可以将多重背包转换成01背包问题，采用二进制思路将第 i 种物品分成了 ![[公式]](https://www.zhihu.com/equation?tex=O%28logn_i%29) 件物品，将原问题转化为了复杂度为 ![[公式]](https://www.zhihu.com/equation?tex=O%28W+%5Csum_i%7Blogn_i%7D%29) 的 01 背包问题，相对于分析一是很大的改进。

## 4. 其他情形

除了上述三种基本的背包问题外，还有一些其他的变种，如下图所示（[图片来源](https://link.zhihu.com/?target=https%3A//blog.csdn.net/weixin_41162823/article/details/87878853)）。

![img](https://pic1.zhimg.com/80/v2-47aefc64bf8e6e42b727f5a460b24bcc_720w.jpg)
...
[Loading...leetcode.com![图标](https://pic1.zhimg.com/v2-0c435ab948b151fd834be55f80a09794_180x120.jpg)](https://link.zhihu.com/?target=https%3A//leetcode.com/problems/partition-equal-subset-sum/)
...
> 另外此题还有一个更巧妙更快的解法，基本思路是用一个bisets来记录所有可能子集的和，详见[我的Github](https://link.zhihu.com/?target=https%3A//github.com/ShusenTang/LeetCode/blob/master/solutions/416.%20Partition%20Equal%20Subset%20Sum.md)。

## 5.2 Coin Change（零钱兑换）

[Loading...leetcode.com![图标](https://pic1.zhimg.com/v2-0c435ab948b151fd834be55f80a09794_180x120.jpg)](https://link.zhihu.com/?target=https%3A//leetcode.com/problems/coin-change/)
...
> 另外此题还可以进行搜索所有可能然后保持一个全局的结果res，但是直接搜索会超时，所以需要进行精心剪枝，剪枝后可击败99%。详见[我的Github](https://link.zhihu.com/?target=https%3A//github.com/ShusenTang/LeetCode/blob/master/solutions/322.%20Coin%20Change.md)。

## 5.3 Target Sum（目标和）

[Loading...leetcode.com![图标](https://pic1.zhimg.com/v2-0c435ab948b151fd834be55f80a09794_180x120.jpg)](https://link.zhihu.com/?target=https%3A//leetcode.com/problems/target-sum/)
...
[Loading...leetcode.com![图标](https://pic1.zhimg.com/v2-0c435ab948b151fd834be55f80a09794_180x120.jpg)](https://link.zhihu.com/?target=https%3A//leetcode.com/problems/ones-and-zeroes/)
...
本文讨论了几类背包问题及LeetCode相关题目，其中01背包问题和完全背包问题是最常考的，另外还需要注意一些其他变种例如恰好装满、二维背包、求方案总数等等。除了本文讨论的这些背包问题之外，还存在一些其他的变种，但只要深刻领会本文所列的背包问题的思路和状态转移方程，遇到其它的变形问题，应该也不难想出算法。如果想更加详细地理解背包问题，推荐阅读经典的[背包问题九讲](https://link.zhihu.com/?target=https%3A//github.com/tianyicui/pack/blob/master/V2.pdf)。